...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String POKEMON_NAME_URL = "https://pokeapi.co/api/v2/pokemon/100/";
    private static final String POKEMON_MACHINES_URL = "https://pokeapi.co/api/v2/machine/455";
